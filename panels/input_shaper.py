...
class InputShaperPanel(ScreenPanel):
    def initialize(self, panel_name):
        ...
        self.calibrate_btn.connect("clicked", self.start_calibration, "both")
    ...
    def start_calibration(self, widget, method):
        ...
        if method == "both":
            ...
            boxko = Gtk.Box()
            boxko.set_size_request(self._screen.width*0.2,self._screen.height*0.2)
            self.lab = Gtk.Label()
    ...
    def measurement_completed(self):
        _ = self.lang.gettext
        self.lab.set_markup(_("<big><b>Measurement completed, please remove the accelerometer</b></big>"))
        # self.lab.set_text(_("Measurement completed, please remove the accelerometer"))
        GLib.timeout_add_seconds(5, self.destroy_dialog)
    ...
    def temergency_stop(self, widget):
        ...
        GLib.timeout_add_seconds(6, self.destroy_dialog)
    ...
    def activate(self):
        ...
        os.system("sh /home/pi/KlipperScreen/scripts/printer/adxl345.sh")
